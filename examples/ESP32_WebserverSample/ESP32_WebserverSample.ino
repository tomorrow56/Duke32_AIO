/*
  ...
  ### OTA Updateの使用方法
  OTA機能を有効にすると、以下のURLでファームウェア更新ページにアクセスできます：
  
  - **OTA更新URL**: `http://[ESP32のIPアドレス]:8080/update`
    - 例: `http://192.168.1.100:8080/update`
  
  ESP32がWiFiに接続後、シリアルモニタに表示されるIPアドレスを確認し、ブラウザで上記URLにアクセスしてください。
*/
